...
- **進捗の報告**: トップの進捗マップの下と、各ナビの完了画面に「報告する」ボタンがあります。押すと、進み具合が入力済みの状態で GitHub の Issue 作成画面が開きます。受講者は**送信を押すだけ**です。Issue には `進捗` ラベルが付くので、[ラベルで絞り込む](https://github.com/aq35/trainer/issues?q=label%3A%E9%80%B2%E6%8D%97)と受講者ごとの状況を一覧できます。
