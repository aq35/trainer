...
<div class="note">
<strong>はじめての方は、こちらの方が迷いません →  <a href="setup.html" target="_blank" rel="noopener">環境構築ナビ</a></strong><br>
1画面に1つの操作だけが表示され、「できましたか？」に答えながら進めます。うまくいかないときは、その場で対処法が出ます。<br>
このページは、全体を一覧で見たい人・あとから確認したい人向けの<strong>手順書版</strong>です。
</div>
