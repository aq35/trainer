# Step 0: パソコンに文字で命令してみる

対象: パソコンは使えるが、「黒い画面」を開いたことがない人。

このStepでは、**まだ何もインストールしません。** Node.jsもClaude Codeも次のStepです。ここでは「文字でパソコンに命令する」感覚だけをつかみます。所要時間は30分ほどです。
...
[Step 1: VS Code + Claude Code の環境をつくる](step1-setup.md)
