...
<strong>土台は、腐りません。2割は、腐ります。</strong>
</div>

| **10年経っても、ほぼ同じもの**（＝土台） | **3年で入れ替わるもの**（＝2割） |
| --- | --- |
| git で記録を残し、戻す | フレームワーク（React / NestJS / …） |
| プルリクエストとレビュー | クラウドのサービス名と画面 |
| 不具合を再現して、切り分ける | 言語の流行 |
| テストで守ってから直す | ライブラリの書き方 |
| 質問する・報告する・見積もる | **AIの使い方すら変わります** |

<div class="note">
<b>だから順番は「土台が先」なのです。</b> 2割は<b>必要になったときに、その時点の最新版</b>を覚えればいい。<br>
<b>先に覚えた2割は、使うころには古くなっています。</b>——そして、土台が無いまま覚えた2割は、<b>そもそも使えません</b>（動かす・記録する・直す手段が無いので）。
</div>

<div class="qa">
<div class="q">つまり、土台をやっている時間は「回り道」ではない？</div>
<div class="a"><b>いちばん短い道です。</b>土台は<b>一度やれば、職種を変えても、言語が変わっても、10年後も使えます</b>。<br>
一方2割は、<b>案件が変わるたびに入れ替わります</b>。どちらに先に時間を使うべきかは、それだけで決まります。</div>
</div>
